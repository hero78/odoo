odoo.define('payment_cinetpay.payment_form', require => {
    'use strict';

    const checkoutForm = require('payment.checkout_form');
    const manageForm = require('payment.manage_form');

    const paymentCinetpayMixin = {
        ...
        _processDirectPayment: function (code, providerId, processingValues) {
            ...
            return this._rpc({
                route: '/payment/cinetpay/simulate_payment',
                params: {
        ...
        /**
         * Prepare the inline form of cinetpay for direct payment.
         *
         * @override method from payment.payment_form_mixin
         * @private
    ...
    checkoutForm.include(paymentCinetpayMixin);
    manageForm.include(paymentCinetpayMixin);
});
